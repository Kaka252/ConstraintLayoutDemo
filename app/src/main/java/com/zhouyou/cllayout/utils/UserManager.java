...
public class UserManager {
    ...
    public static List<User> getUsers() {
        ...
        users.add(new User("郭峰", AVATARS[0]));
        users.add(new User("王大田", AVATARS[1]));
        users.add(new User("特别特别特别特别特特别长的名字", AVATARS[2]));
        users.add(new User("特别特别长的名字", AVATARS[3]));
        users.add(new User("俞老师", AVATARS[4]));
        users.add(new User("三BB", AVATARS[5]));
        return users;
    }
}
